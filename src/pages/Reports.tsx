...
interface ReportData {
  ...
  categoryFilter: 'suppliers' | 'persons'
}
...
const Reports = () => {
  ...
  const exportToPDF = () => {
    ...
    // Add title
    pdf.setFontSize(20)
    pdf.text(`${currentFilter === 'suppliers' ? 'Supplier' : 'Person'} Transaction Report`, 20, 20)
    ...
    pdf.save(`${currentFilter === 'suppliers' ? 'supplier' : 'person'}-transaction-report-${dateFrom}-to-${dateTo}.pdf`)
  }
              ...
              <div className="grid grid-cols-1 xl:grid-cols-2 gap-4 sm:gap-6">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-gray-900 mb-4">
                    {reportData.categoryFilter === 'suppliers' ? 'Top Suppliers' : 'Top Persons'}
                  </h3>
